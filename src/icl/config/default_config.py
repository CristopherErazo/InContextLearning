...
@dataclass
class ModelArgs:
    vocab_size: int = field(default=124,**ui_metadata)  # Vocabulary size
    alpha_dim: float = field(default=0.9,**ui_metadata)  # Quotient d/V
    alpha_length: float = field(default=0.5,**ui_metadata)  # Quotient L/V
...
class OptimArgs:
    ...
    alpha_lr: float = field(default=.015,**ui_metadata)  # Base learning rate factor
...
class ExtraArgs:
    ...
    enable_control: bool = field(default=True,**ui_metadata)  # Enable control features
